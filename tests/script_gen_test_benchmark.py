...
# def gen_equi_benchmark(patch_random):
    ...
    deepti.equi.make_task(iter_name='equi_benchmark/npt', jdata=equi_npt_benchmark_settings)

    with open('npt_meam.json', 'r') as f:
        equi_npt_meam_benchmark_settings = json.load(f)
    deepti.equi.make_task(iter_name='equi_benchmark/npt_meam', jdata=equi_npt_meam_benchmark_settings)
