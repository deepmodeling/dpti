...
def add_module_subparsers(main_subparsers):
    ...
    parser_compute.add_argument('-d','--disorder-corr', action = 'store_true',
                             help='apply disorder correction for ice')
    parser_compute.add_argument('-p','--partial-disorder', type=str,
                             choices = ['3', '5'],
    ...
    parser_refine.add_argument('-p', '--print', action = 'store_true',
